package com.rbc.gam.head2head.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("H2H");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("H2H");
        ...
        config.getMapConfigs().put("com.rbc.gam.head2head.domain.*", initializeDomainMapConfig(jHipsterProperties));
